...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=1A3A5C&center=true&vCenter=true&width=700&lines=Hi+%F0%9F%91%8B+I'm+Santhosh+Vishwanadula;Senior+AI+%2F+ML+Engineer;Generative+AI+%7C+LLMs+%7C+RAG+%7C+MLOps;Building+AI+that+works+in+production" alt="Typing SVG" />
...
```python
class SanthoshVishwanadula:
    def __init__(self):
        self.name       = "Santhosh Vishwanadula"
        self.role       = "Senior AI / ML Engineer"
        self.location   = "United States 🇺🇸"
        self.education  = [
            "MS Data Science & Analytics — Florida Atlantic University (2024)",
            "B.Tech Computer Science — JNTU Hyderabad (2020)"
        ]
        self.experience = "5+ years"
        self.focus      = ["Generative AI", "LLMs", "RAG Pipelines", "MLOps"]
        self.currently  = "Senior AI/ML Engineer @ J.C. Penney"
        self.seeking    = "Senior AI/ML | Applied AI | GenAI roles in the US"
        self.contact    = "santhoshvishwanadula7@gmail.com"

    def say_hi(self):
        print("Thanks for visiting! I build AI systems that work in production.")
```
...
| Area | Details |
|---|---|
| 🤖 **Generative AI & LLMs** | OpenAI API, Azure OpenAI, LangChain, Hugging Face, Prompt Engineering |
| 🔍 **RAG & Semantic Search** | FAISS, Azure Cognitive Search, Embeddings, Vector Pipelines |
| 🧠 **ML & Deep Learning** | Scikit-learn, XGBoost, PyTorch, TensorFlow, Anomaly Detection |
| ⚙️ **MLOps & DevOps** | MLflow, Apache Airflow, Docker, Kubernetes, CI/CD, Azure DevOps |
| ☁️ **Cloud Platforms** | AWS SageMaker, EC2, S3 · Azure Databricks, ADLS Gen2, Synapse |
| 📊 **Data Engineering** | PySpark, Pandas, Azure Data Factory, SQL, Power BI, Tableau |
| 🌐 **API Development** | FastAPI, REST APIs, PostgreSQL, MongoDB |
...
```
2024 – Present  │  Senior AI/ML Engineer @ J.C. Penney (Plano, TX)
                │  GenAI · RAG · LLMs · AWS · MLOps
                │
2020 – 2023     │  Machine Learning Engineer @ NTT DATA (Noida, India)
                │  Azure OpenAI · LangChain · PyTorch · Databricks
                │
2019 – 2020     │  Data Engineer @ NTT DATA (Noida, India)
                │  PySpark · Azure Data Factory · Synapse · Power BI
```
...
I'm actively looking for **Senior AI/ML Engineer**, **Applied AI**, and **Generative AI** roles in the US.
...
<div align="center">
<i>"I don't just build AI models — I build AI systems that work reliably in production."</i>
</div>
